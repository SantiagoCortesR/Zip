                        ...
                        @csrf  
                            <div id="accordion">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <input type="text" name="first_name" id="first_name" class="form-control" placeholder="Student first name" value="{{$enquiry->first_name , old('first_name')}}" required>
                                                    @if ($errors->has('first_name'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('first_name') }}</h5>
                                                    @endif
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <input type="text" name="last_name" class="form-control" placeholder="Student last name" value="{{$enquiry->last_name , old('last_name')}}" required>
                                                    @if ($errors->has('last_name'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('last_name') }}</h5>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    <input type="text" data-provide="datepicker" name="date_of_birth" data-date-format="yyyy-mm-dd" class="form-control " placeholder="Date of Birth" value="{{$enquiry->date_of_birth}}" required>
                                                    @if ($errors->has('date_of_birth'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('date_of_birth') }}</h5>
                                                    @endif
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    ...
                                                    @if ($errors->has('language_home'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('language_home') }}</h5>
                                                    @endif
                                                </div>
                                                <div class="col-12 col-sm-4 mb-3">
                                                    <select name="gender" class="js-custom-select form-control" data-hs-select2-options='{                                       
                                                        ...
                                                        <option {{ old('gender') == ''   ? 'selected' : '' }} value="" selected disabled>Gender</option>
                                                        <option {{ old('gender') == 'Male'   ? 'selected' : '' }} value="Male">Male</option>
                                                        <option {{ old('gender') == 'Female' ? 'selected' : '' }} value="Female">Female</option>
                                                        <option {{ old('gender') == 'Other'  ? 'selected' : '' }} value="Other">Other</option>
                                                    </select>
                                                    @if ($errors->has('gender'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('gender') }}</h5>
                                                    @endif
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-12 mb-3">
                                                    <select name="delivered" class="js-custom-select form-control" data-hs-select2-options='{                                       
                                                        ...
                                                        <option {{ old('delivered') == ''   ? 'selected' : '' }} value="">How would you like your support delivered?</option>
                                                        <option {{ old('delivered') == 'Online'   ? 'selected' : '' }} value="Online">Online</option>
                                                        <option {{ old('delivered') == 'In Person'   ? 'selected' : '' }} value="In Person">In Person</option>
                                                        <option {{ old('delivered') == 'Combination Online - In person'   ? 'selected' : '' }} value="Combination Online - In person">Combination Online - In person</option>
                                                    </select>
                                                    @if ($errors->has('delivered'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('delivered') }}</h5>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12 col-sm-12 mb-3">
                                                    <select name="subjet" id="subjet" onchange="subjets()" class="js-custom-select" data-hs-select2-options='{                                       
                                                        ...
                                                        <option {{ old('subjet') == ''   ? 'selected' : '' }} value="">Which subject would you like help with?</option>
                                                        <option {{ old('subjet') == 'Chemistry'   ? 'selected' : '' }} value="Chemistry">Chemistry</option>
                                                        <option {{ old('subjet') == 'English'   ? 'selected' : '' }} value="English">English</option>
                                                        <option {{ old('subjet') == 'Essay Writing'   ? 'selected' : '' }} value="Essay Writing">Essay writing</option>
                                                        <option {{ old('subjet') == 'Exam Preparation'   ? 'selected' : '' }} value="Exam Preparation">Exam Preparation</option>
                                                        <option {{ old('subjet') == 'Mathematics'   ? 'selected' : '' }} value="Mathematics">Mathematics</option>
                                                        <option {{ old('subjet') == 'organisation and study skills'   ? 'selected' : '' }} value="organisation and study skills">Organisation and study skills</option>
                                                        <option {{ old('subjet') == 'Physics'   ? 'selected' : '' }} value="Physics">Physics</option>
                                                        <option {{ old('subjet') == 'Other'   ? 'selected' : '' }} value="Other">Other</option>
                                                    </select>
                                                    @if ($errors->has('subjet'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('subjet') }}</h5>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-12 " id="subjetOne">
                                                    <select name="package" id="package" onchange="packages()" class="js-custom-select" data-hs-select2-options='{                                       
                                                        ...
                                                        <option {{ old('package') == ''   ? 'selected' : '' }} value="">What type of support package would you like?</option>
                                                        <option {{ old('package') == 'Academic Coaching'   ? 'selected' : '' }} value="Academic Coaching">Academic Coaching - Support of school-based learning</option>
                                                        <option {{ old('package') == 'Academic Extension'   ? 'selected' : '' }} value="Academic Extension">Academic Extension - Broaden skills and understanding beyond grade-level</option>
                                                        <option {{ old('package') == 'Academic Intervention'   ? 'selected' : '' }} value="Academic Intervention">Academic Intervention - Specialised instruction tailored to student needs</option>
                                                        <option {{ old('package') == 'Diagnostic Assessment'   ? 'selected' : '' }} value="Diagnostic Assessment">Diagnostic Assessment</option>
                                                    </select>
                                                    @if ($errors->has('package'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('package') }}</h5>
                                                    @endif
                                                </div>
                                                <div class="col-12 col-sm-12 packageSelectHide" id="subjetTwo">
                                                    <select name="package1" id="package-1" onchange="packages1()" class="js-custom-select " data-hs-select2-options='{                                       
                                                        ...
                                                        <option {{ old('package1') == ''   ? 'selected' : '' }} value="">What type of support package would you like</option>
                                                        <option {{ old('package1') == 'Academic Coaching'   ? 'selected' : '' }} value="Academic Coaching">Academic Coaching - Support of school-based learning</option>
                                                    </select>
                                                    @if ($errors->has('package1'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('package1') }}</h5>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="row pt-3">
                                                <div class="col-12 col-sm-12 packageSelectHide" id="packageOne">
                                                    <select name="type_package" class="js-custom-select" data-hs-select2-options='{                                       
                                                        ...
                                                        <option {{ old('type_package') == ''   ? 'selected' : '' }} value="" selected>How long would you like tutoring for?</option>
                                                        <option {{ old('type_package') == "I'm not sure yet"   ? 'selected' : '' }} value="I'm not sure yet">I'm not sure yet</option>
                                                        <option {{ old('type_package') == 'Ongoing - 1 lesson per week ongoing'   ? 'selected' : '' }} value="Ongoing - 1 lesson per week ongoing">Ongoing - 1 Lesson per week ongoing</option>
                                                        <option {{ old('type_package') == 'Ongoing Intensive - 2 lesson per week ongoing'   ? 'selected' : '' }} value="Ongoing Intensive - 2 lesson per week ongoing">Ongoing Intensive - 2 Lesson per week ongoing</option>
                                                        <option {{ old('type_package') == 'single lesson - 1 lesson per week for 1 week'   ? 'selected' : '' }} value="single lesson - 1 lesson per week for 1 week">Single lesson - 1 Lesson per week for 1 week</option>
                                                        <option {{ old('type_package') == 'three weeks - 1 lesson per week for 3 weeks'   ? 'selected' : '' }} value="three weeks - 1 lesson per week for 3 weeks">Three weeks - 1 Lesson per week for 3 weeks </option>
                                                        <option {{ old('type_package') == 'five weeks - 1 lesson per week for 5 weeks'   ? 'selected' : '' }} value="five weeks - 1 lesson per week for 5 weeks">Five weeks - 1 Lesson per week for 5 weeks</option>
                                                        <option {{ old('type_package') == 'Single term intensive - 3 lesson per week for 10 weeks'   ? 'selected' : '' }} value="Single term intensive - 3 lesson per week for 10 weeks">Single term intensive - 3 Lesson per week for 10 weeks</option>
                                                    </select>
                                                    @if ($errors->has('type_package'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('type_package') }}</h5>
                                                    @endif
                                                </div>
                                                <div class="col-12 col-sm-12 packageSelectHide" id="packageTwo">
                                                    <select name="type_package1" class="js-custom-select" data-hs-select2-options='{                                       
                                                        ...
                                                        <option {{ old('type_package') == ''   ? 'selected' : '' }} value="" disabled>How long would you like tutoring for?</option>
                                                        <option {{ old('type_package') == "I'm not sure yet"   ? 'selected' : '' }} value="I'm not sure yet">I'm not sure yet</option>
                                                        <option {{ old('type_package') == 'Ongoing - 1 lesson per week ongoing'   ? 'selected' : '' }} value="Ongoing - 1 lesson per week ongoing">Ongoing - 1 Lesson per week ongoing</option>
                                                        <option {{ old('type_package') == 'Ongoing Intensive - 2 lesson per week ongoing'   ? 'selected' : '' }} value="Ongoing Intensive - 2 lesson per week ongoing">Ongoing Intensive - 2 Lesson per week ongoing</option>
                                                    </select>
                                                    @if ($errors->has('type_package1'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('type_package1') }}</h5>
                                                    @endif
                                                    {{-- <div class="invalid-feedback margin-top-validate">This field is required</div> --}}
                                                </div>
                                                <div class="col-12 col-sm-12 packageSelectHide" id="packageThree">
                                                    ...
                                                    @if ($errors->has('type_package2'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('type_package2') }}</h5>
                                                    @endif
                                                    {{-- <div class="invalid-feedback margin-top-validate">This field is required</div> --}}
                                                </div>
                                            </div>
                                ...
                                <div class="card mb-1 shadow-none">
                                    ...
                                    <div id="collapseTwo" id="parent" class="collapse @if($errors->any()){{'show'}}@endif " aria-labelledby="headingTwo" data-parent="#accordion">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    <select name="parent_iam" class="js-custom-select" data-hs-select2-options='{                                       
                                                        ...
                                                        <option {{ old('parent_iam') == ''   ? 'selected' : '' }} value="">I am ...</option>
                                                        <option {{ old('parent_iam') == 'I am the student'   ? 'selected' : '' }} value="I am the student">I am the student</option>
                                                        <option {{ old('parent_iam') == 'The parent of a student'   ? 'selected' : '' }} value="The parent of a student">The parent of the student</option>
                                                        <option {{ old('parent_iam') == 'The guardian of a student'   ? 'selected' : '' }} value="The guardian of a student">The guardian of the student</option>
                                                    </select>
                                                    @if ($errors->has('parent_iam'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('parent_iam') }}</h5>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="row">
                                ...
                                <div class="card mb-1 shadow-none">
                                    ...
                                    <div id="collapseThree" class="collapse @if($errors->any()){{'show'}}@endif" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-5">
                                                    ...
                                                    @if ($errors->has('school'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('school') }}</h5>
                                                    @endif
                                                    {{-- <div class="invalid-feedback margin-top-validate">This field is required</div>
                                                ...
                                                <div class="col-12 col-sm-3">
                                                    <!-- Select grade -->
                                                    <input name="grade" type="text" class="form-control" placeholder="Grade" value="{{ old('grade') }}" required>
                                                    @if ($errors->has('grade'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('grade') }}</h5>
                                                    @endif
                                                    <!-- End Select grade end-->
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    <input name="teacher_name" type="text" class="form-control" value="{{ old('teacher_name') }}"  placeholder="Teacher Name">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12 col-sm-8">
                                ...
                                <div class="card mb-1 shadow-none">
                                    ...
                                    <div id="collapseFour" class="collapse @if($errors->any()){{'show'}}@endif" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            <!--in case of emergency-->
                                            <div class="row">
                                                <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <input name="emergency_name" type="text" class="form-control" placeholder="Name" value="{{ old('emergency_name') }}" required>
                                                    @if ($errors->has('emergency_name'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('emergency_name') }}</h5>
                                                    @endif
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <select name="emergency_relation" class="js-custom-select" data-hs-select2-options='{
                                                        ...
                                                        <option {{ old('emergency_relation') == 'Parent'   ? 'selected' : '' }} value="Parent">Parent</option>
                                                        <option {{ old('emergency_relation') == 'Grandparent'   ? 'selected' : '' }} value="Grandparent">Grandparent</option>
                                                        <option {{ old('emergency_relation') == 'Carer'   ? 'selected' : '' }} value="Carer">Carer</option>
                                                        <option {{ old('emergency_relation') == 'Aunt'   ? 'selected' : '' }} value="Aunt">Aunt</option>
                                                        <option {{ old('emergency_relation') == 'Uncle'   ? 'selected' : '' }} value="Uncle">Uncle</option>
                                                        <option {{ old('emergency_relation') == 'Stepparent'   ? 'selected' : '' }} value="Stepparent">Stepparent</option>
                                                        <option {{ old('emergency_relation') == 'Family Friend'   ? 'selected' : '' }} value="Family Friend">Family Friend</option>
                                                        <option {{ old('emergency_relation') == 'Neighbour'   ? 'selected' : '' }} value="Neighbour">Neighbour</option>
                                                        <option {{ old('emergency_relation') == 'Other'   ? 'selected' : '' }} value="Other">Other</option>
                                                    </select>
                                                    @if ($errors->has('emergency_relation'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('emergency_relation') }}</h5>
                                                    @endif
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input name="emergency_mobile" type="text" class="form-control" placeholder="Phone number" value="{{ old('emergency_mobile') }}" required>
                                                        @if ($errors->has('emergency_mobile'))
                                                            <h5 class="text-danger font-size-15">{{ $errors->first('emergency_mobile') }}</h5>
                                                        @endif
                                                    </div>
                                                    <!-- End Phone Number -->
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <input name="emergency_phone" type="text" class="form-control" placeholder="Home Phone" value="{{ old('emergency_phone') }}">
                                                    @if ($errors->has('emergency_phone'))
                                                            <h5 class="text-danger font-size-15">{{ $errors->first('emergency_phone') }}</h5>
                                                        @endif
                                                </div>
                                ...
                                <div class="card mb-1 shadow-none">
                                    ...
                                    <div id="collapseFive" class="collapse @if($errors->any()){{'show'}}@endif" aria-labelledby="headingThree" data-parent="#accordion">
                                ...
                                <div class="card mb-1 shadow-none">
                                    ...
                                    <div id="collapseSix" class="collapse @if($errors->any()){{'show'}}@endif" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            <!--in case of emergency-->
                                            <div class="row">
                                                <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    ...
                                                    @if ($errors->has('payment'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('payment') }}</h5>
                                                    @endif
                                ...
                                <div class="card mb-1 shadow-none">
                                    ...
                                    <div id="collapseSeven" class="collapse @if($errors->any()){{'show'}}@endif" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            <!--in case of emergency-->
                                            <div class="row">
                                                <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    @if ($errors->has('about'))
                                                        <h5 class="text-danger font-size-15">{{ $errors->first('about') }}</h5>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="row">
                            ...
                            <div class="row top-padding  ">
                                <div class="col-8 bg-trama px-4 py-4 rounded">
                                    ...
                                    @if ($errors->has('terms'))
                                        <h5 class="text-danger font-size-15">{{ $errors->first('terms') }}</h5>
                                    @endif
