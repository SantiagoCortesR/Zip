...
<div class="row" id="cerrar">
    <div class="col-12">
        <div class="alert alert-info alert-dismissible fade show" role="alert">
            ...
            <ul>
                <li>Attendance date format change</li>
                <li>Creation of attendance role, which allows the visualization of all attendance</li>
                <li>functional attendance application corrections made, tests carried out with Campbell Jepson</li>
            </ul>
...
{{-- <div class="row" id="cerrar">
    <div class="col-12">
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            It is recommended to log out, at the end of the activities in the database, from the upper right menu Log Out
            <button type="button" class="close" data-dismiss="alert" aria-label="Close" onclick="cerrar()">
                <span aria-hidden="true">×</span>
            </button>
        </div>
            ...
            <div class="card bg-primary">
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="text-white-50">
                                <h5 class="text-white">Tutor Message</h5>
                                <div>
                                    <button data-toggle="modal" data-target="#messagesTutorsModal" class="btn btn-outline-warning btn-sm">Send Message</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                    ...
                    <table class="table table-striped text-end">
                        <tbody class="">
                            ...
                            <tr role="row text-center" >
                                <td class="table-column-pl-0 pt-3 py-3">
