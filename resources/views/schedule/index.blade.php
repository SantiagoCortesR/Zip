    ...
    <div class="row">
        ...
        <div class="col-md-4 offset-md-4 ">
            <div class="btn-group mr-1 btn-block">
                <button type="button" class="btn btn-info mb-3 py-3 font-size-18 dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">More Actions</button>
