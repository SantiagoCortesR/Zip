                    ...
                    <div class="form-content">
                        <div class="form-items">
                            ...
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 p-auto">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <input type="text" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="{{ old('date_of_birth')}}"  name="date_of_birth" class="form-control " placeholder="Date of Birth" required>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12">
                                        ...
                                        @if ($errors->has('parent_name'))
                                            <h5 class="text-danger font-size-15">{{ $errors->first('parent_name') }}</h5>
                                        @endif
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        @if ($errors->has('parent_mobile'))
                                            <h5 class="text-danger font-size-15">{{ $errors->first('parent_mobile') }}</h5>
                                        @endif
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        ...
                                        @if ($errors->has('parent_email'))
                                            <h5 class="text-danger font-size-15">{{ $errors->first('parent_email') }}</h5>
                                        @endif
                                    </div>
                                    {{-- <div class="col-12 col-sm-6">
