...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-auto">
            <a href="{{ route('employees.index') }}" class="badge badge-secondary mb-2 p-2">Go Back</a>
        </div>
    </div>
        ...
        <div class="col-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        {{-- @dump($subjects) --}}
                            ...
                            {{-- @forelse ($subjects  as $subject)
                                <span class="badge badge-primary p-1 mt-1">{{$subject->name}}</span>
                            @empty
                                <span class="badge badge-primary p-1 mt-1">Empty</span>
                            @endforelse --}}
                    ...
                    {{-- <button type="button" class="btn btn-info btn-sm mb-2">Edit Profile</button> --}}
            ...
            {{-- <div class="modal fade" id="deleteModal{{ $user->id }}" tabindex="-1"
                ...
                <form method="POST" action="{{route('employees.delete', $user)}}">
                    @csrf
                    @method('DELETE')
                    <div class="modal-dialog modal-sm modal-dialog-centered">
                        <div class="modal-content red-danger border-red-danger">
                            <div class="modal-body border-danger text-white text-center">
                                ...
                                you want to delete {{ $user->name }} <br>this process cannot be reversed<br>
